...
@section('content')
  <main>
    ...
    <div class="consigliati mb-24">
      <h2 class="title">{{ __('Consigliati da noi') }}</h2>
    ...
    <div class="promo">
      <div class="text">
        ...
        <b>Tutti i film ogni mercoledì a 4€</b>
      </div>

      <svg width="75" height="74" viewBox="0 0 55 54" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M20.2687 44.82L34.9387 30.15C36.6712 28.4175 36.6712 25.5825 34.9387 23.85L20.2687 9.17999" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
    </div>
